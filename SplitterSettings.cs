...
namespace LiveSplit.MasterSpy {
	public partial class SplitterSettings : UserControl {
		...
		private void Settings_Load(object sender, EventArgs e) {
			FindForm().Text = "Master Spy Autosplitter v" + Assembly.GetExecutingAssembly().GetName().Version.ToString(3);
			LoadSettings();
		}
		...
		private void btnMissionSplits_Click(object sender, EventArgs e) {
			if (Splits.Count > 0 && MessageBox.Show(this, "You already have some splits setup. This will clear anything you have and default in the Mission splits.\r\n\r\nAre you sure you want to continue?", "Warning", MessageBoxButtons.YesNo, MessageBoxIcon.Warning) != DialogResult.Yes) {
				return;
			}

			Splits.Clear();
			Splits.Add(SplitName.Level_01_10);
			Splits.Add(SplitName.Level_02_10);
			Splits.Add(SplitName.Level_03_10);
			Splits.Add(SplitName.Level_04_10);
			Splits.Add(SplitName.Level_05_10);

			LoadSettings();
		}
		private void btnAllLevels_Click(object sender, EventArgs e) {
			if (Splits.Count > 0 && MessageBox.Show(this, "You already have some splits setup. This will clear anything you have and default in the All Level splits.\r\n\r\nAre you sure you want to continue?", "Warning", MessageBoxButtons.YesNo, MessageBoxIcon.Warning) != DialogResult.Yes) {
				return;
			}

			Splits.Clear();
			Splits.Add(SplitName.Level_01_01);
			Splits.Add(SplitName.Level_01_02);
			Splits.Add(SplitName.Level_01_03);
			Splits.Add(SplitName.Level_01_04);
			Splits.Add(SplitName.Level_01_05);
			Splits.Add(SplitName.Level_01_06);
			Splits.Add(SplitName.Level_01_07);
			Splits.Add(SplitName.Level_01_08);
			Splits.Add(SplitName.Level_01_09);
			Splits.Add(SplitName.Level_01_10);
			Splits.Add(SplitName.Level_02_01);
			Splits.Add(SplitName.Level_02_02);
			Splits.Add(SplitName.Level_02_03);
			Splits.Add(SplitName.Level_02_04);
			Splits.Add(SplitName.Level_02_05);
			Splits.Add(SplitName.Level_02_06);
			Splits.Add(SplitName.Level_02_07);
			Splits.Add(SplitName.Level_02_08);
			Splits.Add(SplitName.Level_02_09);
			Splits.Add(SplitName.Level_02_10);
			Splits.Add(SplitName.Level_03_01);
			Splits.Add(SplitName.Level_03_02);
			Splits.Add(SplitName.Level_03_03);
			Splits.Add(SplitName.Level_03_04);
			Splits.Add(SplitName.Level_03_05);
			Splits.Add(SplitName.Level_03_06);
			Splits.Add(SplitName.Level_03_07);
			Splits.Add(SplitName.Level_03_08);
			Splits.Add(SplitName.Level_03_09);
			Splits.Add(SplitName.Level_03_10);
			Splits.Add(SplitName.Level_04_01);
			Splits.Add(SplitName.Level_04_02);
			Splits.Add(SplitName.Level_04_03);
			Splits.Add(SplitName.Level_04_04);
			Splits.Add(SplitName.Level_04_05);
			Splits.Add(SplitName.Level_04_06);
			Splits.Add(SplitName.Level_04_07);
			Splits.Add(SplitName.Level_04_08);
			Splits.Add(SplitName.Level_04_09);
			Splits.Add(SplitName.Level_04_10);
			Splits.Add(SplitName.Level_05_01);
			Splits.Add(SplitName.Level_05_02);
			Splits.Add(SplitName.Level_05_03);
			Splits.Add(SplitName.Level_05_04);
			Splits.Add(SplitName.Level_05_05);
			Splits.Add(SplitName.Level_05_06);
			Splits.Add(SplitName.Level_05_07);
			Splits.Add(SplitName.Level_05_08);
			Splits.Add(SplitName.Level_05_09);
			Splits.Add(SplitName.Level_05_10);
