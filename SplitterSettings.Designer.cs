namespace LiveSplit.MasterSpy {
	partial class SplitterSettings {
		...
		private void InitializeComponent() {
			...
			this.flowMain.Size = new System.Drawing.Size(246, 29);
			...
			this.flowOptions.Size = new System.Drawing.Size(246, 29);
			...
			this.btnChapterSplits.Size = new System.Drawing.Size(57, 23);
			this.btnChapterSplits.TabIndex = 1;
			this.btnChapterSplits.Text = "Missions";
			this.btnChapterSplits.UseVisualStyleBackColor = true;
			this.btnChapterSplits.Click += new System.EventHandler(this.btnMissionSplits_Click);
			// 
			// btnChapterCheckpointSplits
			// 
			this.btnChapterCheckpointSplits.AutoSize = true;
			this.btnChapterCheckpointSplits.Location = new System.Drawing.Point(181, 3);
			this.btnChapterCheckpointSplits.Name = "btnChapterCheckpointSplits";
			this.btnChapterCheckpointSplits.Size = new System.Drawing.Size(62, 23);
			this.btnChapterCheckpointSplits.TabIndex = 2;
			this.btnChapterCheckpointSplits.Text = "All Levels";
			this.btnChapterCheckpointSplits.UseVisualStyleBackColor = true;
			this.btnChapterCheckpointSplits.Click += new System.EventHandler(this.btnAllLevels_Click);
			// 
			// SplitterSettings
			// 
